...
if (!homeData) return null;
  ...
  {/* Section 1 */}
  <div className="w-11/12 md:w-4/5 lg:w-3/5 h-auto md:h-[85%] 2xl:h-[85%] 2xl:w-[65%] mt-10 md:mt-2 bg-gray-50 rounded-3xl flex flex-col items-center justify-center navbar-shadow p-4 md:p-6">
